// ============================================================
// DUMMY DATA — fallback before real DB data is available
// ============================================================
const DUMMY_ROADMAP = {
  skillId: 'frontend',
...
const DEFAULT_PROGRESS: UserProgress = {
  ...
  stages: {
    s1: { isPracticeUnlocked: true, earnedStars: 3, isCompleted: true, theoryRead: true, videoWatchPercentage: 100 },
    s2: { isPracticeUnlocked: true, earnedStars: 3, isCompleted: true, theoryRead: true, videoWatchPercentage: 100 },
    s3: { isPracticeUnlocked: true, earnedStars: 3, isCompleted: true, theoryRead: true, videoWatchPercentage: 100 },
    s4: { isPracticeUnlocked: true, earnedStars: 3, isCompleted: true, theoryRead: true, videoWatchPercentage: 100 },
    s5: { isPracticeUnlocked: false, earnedStars: 0, isCompleted: false, theoryRead: false, videoWatchPercentage: 0 },
    s6: { isPracticeUnlocked: false, earnedStars: 0, isCompleted: false, theoryRead: false, videoWatchPercentage: 0 },
    s7: { isPracticeUnlocked: false, earnedStars: 0, isCompleted: false, theoryRead: false, videoWatchPercentage: 0 },
    s8: { isPracticeUnlocked: false, earnedStars: 0, isCompleted: false, theoryRead: false, videoWatchPercentage: 0 },
    s9: { isPracticeUnlocked: false, earnedStars: 0, isCompleted: false, theoryRead: false, videoWatchPercentage: 0 },
  },
};
